...
class car:
    def __init__(self,brand,color,year,bak,benzen,mator,masofa,km=0):
        self.nomi=brand
        self.rangi=color
        self.yil=year
        self.bak=bak
...
n=int(input("Masofani kiriitng: "))

c1=car("BMW","Black",2022,80,10,False,n)
c1.drive()
b=int(input("qancha benzin quyasiz: "))
